...
class LoginCubit extends Cubit<LoginState> {
  ...
  Future<void> login() async {
    ...
    emit(LoginLoading());
   var either= await loginUseCase.invoke(e_mailController.text, passwordController.text);
   either.fold((l) => emit(LoginErrorState(errorMessage: l.errorMessage)), (r) => emit(LoginSuccessState(
    authResultEntity: r
   )));
